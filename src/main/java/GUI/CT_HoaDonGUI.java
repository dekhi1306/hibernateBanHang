...
//                    cleanView();
//                    tbl.clearSelection();
//                    outModel(model, (ArrayList<ct_hoadon>) ctBUS.getCt_hdBUS());
//                }
//            }
//        });
        /**
    ...
    public void outModel(DefaultTableModel model, ArrayList<ct_hoadon> hd) {     //xuat tu arraylist len table
        Vector data;
        model.setRowCount(0);
        for (ct_hoadon h : hd) {
            data = new Vector();
    ...
    public void list() // Chép ArrayList lên table
    {
        ...
        ArrayList<ct_hoadon> cthd = (ArrayList<ct_hoadon>) ctBLL.getList();
        model.setRowCount(0);
        outModel(model, cthd);
    }
