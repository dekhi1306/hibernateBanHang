...
public class NhapHangGUI extends JPanel implements ActionListener {
    ...
    public void init() {
        ...
        btnAdd.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (!txtMaPNH.getText().equals("")) {      
                    JOptionPane.showMessageDialog(null ,"Vui lòng làm mới lại dữ liệu trước khi chọn !!!", "Warning", 
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null ,"Vui lòng chọn đầy đủ nhân viên hoặc nhà cung cấp để nhập hàng !!!", "Warning", 
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
        ...
        btnView.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (txtMaPNH.getText().equals("")) {
                    JOptionPane.showMessageDialog(null ,"Vui lòng chọn phiếu nhập hàng cần xem !!!", "Warning", 
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
...
//        /******************************************/
    ...
    public void outModel(DefaultTableModel model, ArrayList<phieunhaphang> hd) {     //xuat tu arraylist len table
        Vector data;
        model.setRowCount(0);
